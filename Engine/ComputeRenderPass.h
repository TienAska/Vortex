...
//namespace Vortex
//{
//    class ComputeRenderPass :public Renderer::IRenderPass
//    {
//    public:
//        ComputeRenderPass()
//        {
...
//            m_commandList = CreateCommandList(m_pipelineState, m_rootSignature, descriptorHeap, descriptorHeap);
//        }
//
...
//        {
//            barrier = new CD3DX12_RESOURCE_BARRIER(CD3DX12_RESOURCE_BARRIER::Transition(m_textureResource.get(), D3D12_RESOURCE_STATE_UNORDERED_ACCESS, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE));
//            return 1;
//        }
//
//    private:
